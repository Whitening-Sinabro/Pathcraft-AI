...
WINDOWS = [
    # 00:43:31 갑옷(Ornate Plate) 교체 — 88->90 스냅샷에서 유일하게 바뀐 장비
    ("body_armour_ornate", 2560, 2760),
    # 00:51:08~00:55:09 장화 구매·방어도 굴림 (2디바인 언급)
    ("boots_shopping", 3040, 3340),
    # 01:11:22~01:13:30 방어도 파괴·무기 스왑 구조 본인 설명
    ("armour_break_weapon_swap", 4270, 4460),
]
